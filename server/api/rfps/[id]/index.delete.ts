import { dbGetRfpById, dbSoftDeleteRfp } from '../../../services/supabase/db'

interface Dependencies {
  getRfpById: typeof dbGetRfpById
  softDeleteRfp: typeof dbSoftDeleteRfp
}

const defaultDependencies: Dependencies = {
  getRfpById: dbGetRfpById,
  softDeleteRfp: dbSoftDeleteRfp,
}

export async function handleDeleteRfp(
  ...
  await deps.softDeleteRfp(rfp.id)
  return { id: rfp.id, deleted: true }
}

export default defineEventHandler(event => handleDeleteRfp(event))